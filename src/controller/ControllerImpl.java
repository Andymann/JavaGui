...
public class ControllerImpl {
	...
	/**
	 * Aufruf einer View. Wenn eine View mit Passwort versehen ist, kann das
	 * Password anschliessend mit ControllerImpl.enterViewPIN_Digit(char)
	 * konstruiert werden.
	 * 
	 * @param pViewID
	 */
	...
	/**
	 * Das komplette(!) Passwort fuer die in ViewFactory auf Freischaltung wartende
	 * View.
	 * 
	 * @param pPassword
	 */
	...
	/**
	 * Im Vorfeld wurde eine PIN konstruiert. Hiermit wird der Versuch gestartet,
	 * mit der PIN die View freizuschalten.
	 */
